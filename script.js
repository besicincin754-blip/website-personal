...
submitName.addEventListener('click', () => {
  ...
  apologyTitle.textContent = `${nickname}, kamu mau ga ngedate sama aku 🥺💖`;

  apologyText.innerHTML = `Aku beneran kangen sama kamu sis.<br>Mau , ya? 😢`;
});
...
yesBtn.addEventListener('click', () => {
  ...
  popupTitle.textContent = `Makasih ya sayang, ${nickname} 💕`;
  popupMsg.textContent = `love you more 🥺✨`;
  generateHearts();
  setTimeout(() => {
